...
namespace DF2023.WebPageHelper
{
    public class GetDataHelper
    {
        ...
        public static List<JToken> GetPassportType(string baseUrl)
        {
            string query = "query\r\n{\r\npassporttype\r\n  {\r\n    passporttypeItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("passporttype").SelectToken("passporttypeItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetDelegationType(string baseUrl)
        {
            string query = "query\r\n{\r\ndelegationType\r\n  {\r\n    delegationTypeItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("delegationType").SelectToken("delegationTypeItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetTitleList(string baseUrl)
        {
            string query = "query\r\n{\r\ntitlelist\r\n  {\r\n    titlelistItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("titlelist").SelectToken("titlelistItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetAirports(string baseUrl)
        {
            string query = "query\r\n{\r\nairport\r\n  {\r\n    airportItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("airport").SelectToken("airportItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetGuestStatus(string baseUrl)
        {
            string query = "query\r\n{\r\ngueststatus\r\n  {\r\n    gueststatusItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("gueststatus").SelectToken("gueststatusItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetGuestStageStatus(string baseUrl)
        {
            ...
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("gueststagestatus").SelectToken("gueststagestatusItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetSubAttendeeType(string baseUrl)
        {
            ...
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("subattendeetype").SelectToken("subattendeetypeItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetBadgeType(string baseUrl)
        {
            string query = "query\r\n{\r\nbadgetype\r\n  {\r\n    badgetypeItems\r\n    {\r\n      id,\r\n      title\r\n    }\r\n  }\r\n}";
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("badgetype").SelectToken("badgetypeItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
        public static List<JToken> GetDelegationMemberType(string baseUrl)
        {
            ...
            var countries = GraphQLHelper.ExecuteQueryAsync(baseUrl, query, null);
            var countryItems = countries.SelectToken("data").SelectToken("delegationmembertype").SelectToken("delegationmembertypeItems").Select(x => x["id"]).ToList();
            return countryItems;
        }
